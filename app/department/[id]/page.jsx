...
export default function Page({ params }) {
  ...
  return (
    <div>
      {params?.id ?
        <div>
          <aside className="ml-[-100%] fixed z-10 top-0 pb-3 pr-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
            <div>
              <ul className="space-y-2 tracking-wide mt-8">

                <Link legacyBehavior href={`/department/${params.id}/`}>
                ...
                <Link legacyBehavior href={`/department/${params.id}/services`}>
                ...
                <Link legacyBehavior href={`/department/${params.id}/forms`}>
                    ...
                    >
                      ...
                      <span className="group-hover:text-gray-700">Forms</span>
                    </a>
                 
                </Link>

                <Link legacyBehavior href={`/department/${params.id}/teams`}>
                    ...
                    >
                      ...
                      <span className="group-hover:text-gray-700">Team</span>
                    </a>
                 
                </Link>
                <Link legacyBehavior href={`/department/${params.id}/policies`}>
                    ...
                    >
                      ...
                      <span className="group-hover:text-gray-700">Policies</span>
                    </a>
                 
                </Link>
                <Link legacyBehavior href={`/department/${params.id}/procedures`}>
                    ...
                    >
                      ...
                      <span className="group-hover:text-gray-700">Procedures</span>
                    </a>
                 
                </Link>
                <Link legacyBehavior href={`/department/${params.id}/manuals`}>
                    ...
                    >
                      ...
                      <span className="group-hover:text-gray-700">Manuals</span>
                    </a>
                 
                </Link>
                <Link legacyBehavior href={`/department/${params.id}/operational-plan`}>
                ...
                <Link legacyBehavior href={`/department/${params.id}/recycle-bin`}>
                ...
                <Link legacyBehavior href={`/department/${params.id}/edit`}>
                    ...
                    >
                      ...
                      <span className="group-hover:text-gray-700">Edit </span>
                    </a>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex justify-center gap-4">
                          <h3 className="text-3xl font-bold text-gray-700">1400</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                      <h5 className="text-xl text-gray-700">Academic Staff</h5>
                      <div className="my-8">
                        <h1 className="text-5xl font-bold text-gray-800">1000</h1>
                      </div>
                      <svg
                        className="w-full"
                        viewBox="0 0 218 69"
                  ...
                  <div className="md:col-span-2 lg:col-span-1">
                    <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex justify-center gap-4">
                          <h3 className="text-3xl font-bold text-gray-700">6</h3>
                        </div>
                      </div>
                    </div>
                  </div>
